    ...
    <nav class="tyn-appbar">
        <div class="tyn-appbar-wrap">
            <div class="tyn-appbar-logo">
                <a class="tyn-logo" href="javascript:void(0)">
                    ...
                    <li class="tyn-appbar-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <div class="tyn-media-group">
                                    ...
                                    <div class="tyn-media-col">
                                        ...
                                        <div class="tyn-media-row has-dot-sap">
                                            <p class="content">{{ Auth::user()->username }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="tyn-list-links">
                                <li>
                                    <a href="javascript:void(0)" wire:click="openProfileModal">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <li>
                                    <a href="javascript:void(0)" wire:click="openChangePasswordModal">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5>
                        ...
                        {{ $modalType == 'profile' ? 'My Profile' : 'Change Password' }}
